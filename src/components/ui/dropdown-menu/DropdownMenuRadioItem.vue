<template>
  <DropdownMenuRadioItem
    ...
    :class="
      cn(
        'relative flex items-center py-1.5 pl-8 pr-2 rounded-sm text-sm cursor-pointer select-none outline-none transition-colors focus:bg-shade-7 data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
        props.class,
      )
    "
  >
